#!/usr/bin/env python3
"""
ClawdBot v8.0 - Truly Intelligent
==================================
An agent that REASONS about tasks, not pattern matches.

Architecture:
1. Tool Registry - Composable tools Claude can discover
...
class ClawdBot:
    ...
    def get_help(self) -> str:
        return f"""ClawdBot v{VERSION} - Truly Intelligent

Just tell me what you want in plain English!

I figure out HOW to do things - no specific commands needed.
...
def main():
    print(f"""
╔═══════════════════════════════════════════════════════════╗
║  ClawdBot v{VERSION} - Truly Intelligent                       ║
